...
export default function SideNav() {
  ...
  return (
    <div className="flex ">
            ...
            <div className="px-2">
              <div className="py-4">
                ...
                >
                  ...
                  <span className="invisible absolute start-full top-1/2 ms-4 -translate-y-1/2 rounded  px-2 py-1.5 text-xs font-medium  group-hover:visible">
                    General
                  </span>
                </a>
              </div>
      ...
      <button className="inline-flexp mt-2 size-[25px] absolute right-[-10px] justify-center rounded-full">
